...
const authoredKap2Sec02 = [
  {
    kp: '001',
    typ: 'begrepp',
    niva: 1,
    stem: 'Vad betyder global i uttrycket global uppvärmning?',
    correct: 'Att uppvärmningen syns som ett mönster över många delar av jorden',
    wrong: ['Att en plats får en ovanligt varm dag', 'Att en art flyttar inom samma område efter en varm vecka', 'Att en kuststräcka får varmare vatten under en vecka'],
    rationales: ['En enskild varm dag är lokal vädervariation.', 'En kort lokal förändring räcker inte för globalt mönster.', 'En kort förändring vid en kust räcker inte för globalt mönster.'],
    solution: 'Global syftar på ett brett mönster över jorden, inte en enskild lokal observation.',
    summary: 'Sanitiserad grundning: delområdet behandlar global uppvärmning.',
    tags: ['global', 'begrepp']
  },
  {
    kp: '001',
    typ: 'samband',
    niva: 2,
    stem: 'Forskare jämför temperaturdata från flera regioner under lång tid. Varför stärker det påståendet om global uppvärmning?',
    correct: 'Det visar om uppvärmning finns som återkommande mönster på många platser',
    wrong: ['Det gör den varmaste regionen till mått för hela jorden', 'Det gör en kort värmeperiod biologiskt avgörande', 'Det låter en artförändring ersätta temperaturdata'],
    rationales: ['En region kan inte representera hela jorden ensam.', 'En kort period ger svagare stöd än lång tidsserie.', 'Artförändring behöver kopplas till temperaturmönstret.'],
    solution: 'Global uppvärmning stöds starkare av långvariga mönster från många platser.',
    summary: 'Sanitiserad grundning: delområdet kopplar global till uppvärmning.',
    tags: ['global', 'uppvärmning']
  },
  {
    kp: '001',
    typ: 'mcq',
    niva: 2,
    stem: 'Vilken observation passar bäst med att uppvärmningen är global?',
    correct: 'Medeltemperaturen stiger i flera regioner samtidigt som livsmiljöer påverkas',
    wrong: ['En damm blir varmare efter några soliga dagar', 'En skogsglänta får fler insekter under en vecka', 'En kuststad mäter högre temperatur nära byggnader under en eftermiddag'],
    rationales: ['Dammen visar en lokal och kort förändring.', 'En vecka med fler insekter visar inte global uppvärmning.', 'En lokal mätmiljö nära byggnader visar inte globalt mönster.'],
    solution: 'Global uppvärmning handlar om bred temperaturförändring med biologiska följder i många miljöer.',
    summary: 'Sanitiserad grundning: delområdet tränar globalt mönster i biologiskt sammanhang.',
    tags: ['global', 'biologiskt samband']
  },
  {
    kp: '001',
    typ: 'resonemang',
    niva: 3,
    stem: 'Ett underlag visar högre medeltemperatur i flera regioner, men bara en biologisk funktion har följts. Vad är rimligast?',
    correct: 'Koppla slutsatsen till funktionen och ange att fler behöver data',
    wrong: ['Låt temperaturmönstret avgöra varje biologisk funktion', 'Regionen där funktionen ändrades mest får störst vikt', 'Byt fokus till väderhändelser som syns tydligare'],
    rationales: ['Omätta funktioner kräver eget stöd.', 'Störst förändring i en region räcker inte för helheten.', 'Tydliga väderhändelser ersätter inte biologisk uppföljning.'],
    solution: 'Ett globalt resonemang kan vara starkt men ska avgränsas till biologiska data som faktiskt finns.',
    summary: 'Sanitiserad grundning: delområdet tränar avgränsat resonemang om global uppvärmning.',
    tags: ['global', 'resonemang']
  },
  {
    kp: '001',
    typ: 'jämförelse',
    niva: 2,
    stem: 'Två underlag jämförs. A visar temperaturtrend i flera regioner men kort biologisk uppföljning. B visar längre biologisk uppföljning i en region under varmare perioder. Vad saknas för ett starkt globalt påstående?',
    correct: 'Data som kopplar lång temperaturtrend till biologisk funktion i flera regioner',
    wrong: ['A räcker eftersom flera regioner ingår även med kort funktionsdata', 'B får avgöra eftersom biologin följts längre i en region', 'Underlaget där effekten syns tydligast räcker som stöd'],
    rationales: ['Flera regioner behöver också biologisk funktion följd över tid.', 'Lång lokal uppföljning räcker inte för globalt påstående.', 'Synlighet är inte samma sak som stark evidens.'],
    solution: 'Ett globalt biologiskt påstående behöver både bred temperaturtrend och biologisk funktion över tid.',
    summary: 'Sanitiserad grundning: delområdet jämför globalt och lokalt underlag.',
    tags: ['global', 'jämförelse']
  },
  {
    kp: '002',
    typ: 'begrepp',
    niva: 1,
    stem: 'Vad betyder uppvärmning i global uppvärmning?',
    correct: 'Att medeltemperaturen ökar över tid',
    wrong: ['Att temperaturen varierar mellan dag och natt', 'Att en plats får varmare eftermiddagar under en vecka', 'Att en mätstation visar hög temperatur vid ett tillfälle'],
    rationales: ['Dygnsvariation är normal vädervariation.', 'En vecka på en plats är lokal och kortvarig.', 'Ett mättillfälle visar inte trend över tid.'],
    solution: 'Uppvärmning beskriver en temperaturökning över tid, inte en enskild varm stund.',
    summary: 'Sanitiserad grundning: delområdet behandlar uppvärmning som begrepp.',
    tags: ['uppvärmning', 'begrepp']
  },
  {
    kp: '002',
    typ: 'samband',
    niva: 2,
    stem: 'I en region blir våren varmare och vissa växter blommar tidigare. Hur kopplas uppvärmning till biologisk funktion?',
    correct: 'Uppvärmningen kan ändra tidpunkten för blomning och samspel med pollinatörer',
    wrong: ['Tidigare blomning visar främst att växterna fått mer jord', 'Pollinatörer påverkas främst av vindriktning samma dag', 'Varmare vår gör blomning till samma funktion i olika miljöer'],
    rationales: ['Jordmängd förklarar inte temperaturkopplingen i scenariot.', 'Vind samma dag förklarar inte långsiktig temperatur och timing.', 'Olika miljöer kan reagera olika på uppvärmning.'],
    solution: 'Uppvärmning kan påverka biologisk timing och därmed funktioner som pollinering.',
    summary: 'Sanitiserad grundning: delområdet kopplar uppvärmning till biologisk funktion.',
    tags: ['uppvärmning', 'biologisk funktion']
  },
  {
    kp: '002',
    typ: 'mcq',
    niva: 2,
    stem: 'En sjö blir varmare under längre perioder och vissa arter söker svalare djup. Vad visar detta biologiskt?',
    correct: 'Uppvärmning kan förändra var arter kan fungera i miljön',
    wrong: ['Djupare vatten gör arterna mer globala', 'Varmare vatten visar främst att arterna fått mer föda', 'Arternas förflyttning gör temperaturen mindre relevant'],
    rationales: ['Djupförflyttning är en lokal biologisk respons, inte globalitet.', 'Mer föda framgår inte av scenariot.', 'Förflyttningen är just en möjlig följd av temperaturen.'],
    solution: 'När temperaturen förändras kan arters livsmiljö och funktion påverkas.',
    summary: 'Sanitiserad grundning: delområdet tränar biologisk följd av uppvärmning.',
    tags: ['uppvärmning', 'biologiskt samband']
  },
  {
    kp: '002',
    typ: 'resonemang',
    niva: 3,
    stem: 'En tidsserie visar att medeltemperaturen ökar under många år, medan två enskilda år är svalare. Vilken slutsats är rimlig?',
    correct: 'Trenden kan ändå visa uppvärmning om mönstret över tid är tydligt',
    wrong: ['De svala åren gör att hela trenden bör räknas som neutral', 'Det varmaste året bör väljas som hela förklaringen', 'Biologiska följder kan avgöras från ett av de svala åren'],
    rationales: ['En trend bedöms över flera år, inte bara av två undantag.', 'Ett enskilt varmt år räcker inte som hel förklaring.', 'Ett år ger svagt stöd för biologiska följder.'],
    solution: 'Uppvärmning bedöms som trend över tid, samtidigt som enskilda år kan variera.',
    summary: 'Sanitiserad grundning: delområdet tränar resonemang om uppvärmning över tid.',
    tags: ['uppvärmning', 'resonemang']
  },
  {
    kp: '002',
    typ: 'jämförelse',
    niva: 2,
    stem: 'Art A kan flytta till svalare miljö men har smalt födoval. Art B är mer platsbunden men har bredare födoval. Vad avgör risken vid uppvärmning?',
    correct: 'Hur rörlighet och födoval påverkar funktionen när platsen värms',
    wrong: ['A har lägst risk eftersom rörlighet väger mer än födoval', 'B har lägst risk eftersom födoval väger mer än platsbundenhet', 'Risk avgörs främst av vilken art som reagerar först'],
    rationales: ['Rörlighet behöver vägas mot födoval.', 'Bredare födoval behöver vägas mot platsbundenhet.', 'Första reaktionen säger inte hela risken för funktion.'],
    solution: 'Uppvärmning kan påverka arter olika beroende på flera biologiska egenskaper, inte bara en faktor.',
    summary: 'Sanitiserad grundning: delområdet jämför biologiska följder av uppvärmning.',
    tags: ['uppvärmning', 'jämförelse']
  },
  {
    kp: '003',
    typ: 'modell',
    niva: 1,
    stem: 'En modell visar temperatur, livsmiljö och artens överlevnad. Vad bör pilen från temperatur till livsmiljö visa?',
    correct: 'Hur uppvärmning kan förändra villkoren i livsmiljön',
    wrong: ['Hur artens utbredning kan påverka temperaturmätningen', 'Hur livsmiljödata kan ersätta temperaturmätningen', 'Hur överlevnad mäts före miljöförändringen'],
    rationales: ['Utbredning är biologisk respons, inte orsak till temperaturmätningen.', 'Livsmiljö och temperatur behöver kopplas.', 'Modellen behöver visa orsakskedjan i rätt riktning.'],
    solution: 'Modellen bör visa att temperaturförändring kan ändra livsmiljön och därmed biologisk funktion.',
    summary: 'Sanitiserad grundning: delområdet modellerar biologiskt samband i global uppvärmning.',
    tags: ['biologiskt samband', 'modell']
  },
  {
    kp: '003',
    typ: 'modell',
    niva: 2,
    stem: 'En modell visar global uppvärmning men hoppar över biologisk funktion. Vad behöver läggas till?',
    correct: 'Vilken funktion som påverkas och hur sambandet går via miljön',
    wrong: ['Regional temperaturtrend där artens funktion lämnas oklar', 'Regionala mönster som får ersätta artdata', 'Ett värde för nytta som får stå för biologisk funktion'],
    rationales: ['Temperaturtrend behöver kopplas till vilken funktion som påverkas.', 'Regionala mönster behöver kopplas till arter eller funktion.', 'Nytta är inte samma sak som biologisk funktion.'],
    solution: 'En biologisk modell behöver visa vilken funktion som förändras och genom vilket samband.',
    summary: 'Sanitiserad grundning: delområdet tränar modellkomplettering.',
    tags: ['biologiskt samband', 'biologisk funktion']
  },
  {
    ...
    typ: 'mcq',
    niva: 2,
    stem: 'Vilken modellkedja visar ett biologiskt samband vid global uppvärmning?',
    correct: 'Medeltemperatur ökar, livsmiljö förändras och artens funktion påverkas',
    wrong: ['Medeltemperatur ökar, utbredning noteras och livsmiljö stärks', 'Livsmiljö förändras, mätmetod ändras och funktionen förbättras', 'Funktionen påverkas, uppvärmningen minskar och regionen blir stabil'],
    rationales: ['Utbredning behöver kopplas till funktion, inte bara noteras.', 'Mätmetod är inte biologiskt samband.', 'Kedjan blandar ihop följd och orsak.'],
    solution: 'Ett biologiskt samband visar hur uppvärmning kan påverka livsmiljö och funktion.',
    summary: 'Sanitiserad grundning: delområdet tränar modellkedja.',
    tags: ['biologiskt samband', 'uppvärmning']
  },
  {
    kp: '003',
    typ: 'resonemang',
    niva: 3,
    stem: 'En modell visar högre temperatur och tidigare blomning, men pollinatörer har följts kort tid. Vad är rimligast?',
    correct: 'Knyt slutsatsen till blomningen och ange att pollinatörer behöver längre uppföljning',
    wrong: ['Låt blomningen avgöra hur pollinatörer förändras i flera regioner', 'Pollinatörsdata får vara huvudbevis trots kort uppföljning', 'Tolka tidigare blomning som säkert stärkt pollinering'],
    rationales: ['Pollinatörer kräver eget och längre underlag.', 'Kort uppföljning ger svagare stöd.', 'Tidigare blomning kan ge både stöd och risk för pollinering.'],
    solution: 'Ett modellresonemang ska följa underlaget och avgränsa vad som kan sägas om biologiskt samband.',
    summary: 'Sanitiserad grundning: delområdet tränar avgränsat modellresonemang.',
    tags: ['biologiskt samband', 'resonemang']
  },
  {
    ...
    typ: 'jämförelse',
    niva: 2,
    stem: 'Modell A kopplar temperatur till ändrad utbredning i flera regioner. Modell B kopplar temperatur till ändrad fortplantning i en region. Vad är viktigast att jämföra biologiskt?',
    correct: 'Vilken modell som kopplar temperatur till funktion och stödets räckvidd bäst',
    wrong: ['Vilken modell som har störst regional spridning i underlaget', 'Vilken modell som visar tydligast förändrad utbredning', 'Vilken modell som visar störst temperaturökning'],
    rationales: ['Regional spridning behöver kopplas till funktion.', 'Tydlig utbredning behöver vägas mot biologisk funktion.', 'Stor temperaturökning behöver kopplas till biologisk funktion.'],
    solution: 'Modeller jämförs biologiskt genom hur väl de visar funktion och samband.',
    summary: 'Sanitiserad grundning: delområdet jämför modeller för global uppvärmning.',
    tags: ['biologiskt samband', 'jämförelse']
  },
  {
    kp: '004',
    typ: 'begrepp',
    niva: 1,
    stem: 'Varför är biologisk funktion viktig när global uppvärmning jämförs?',
    correct: 'Funktionen visar vad som händer med organismers sätt att leva och överleva',
    wrong: ['Funktionen visar främst vilken region som värms snabbast', 'Funktionen gör temperaturmätningar mindre viktiga', 'Funktionen räcker som bevis när temperaturdata är kort'],
    rationales: ['Snabbast uppvärmning behöver kopplas till levande system.', 'Temperaturdata behövs för att koppla orsak och följd.', 'Kort temperaturdata ger begränsat stöd.'],
    solution: 'Biologisk funktion visar hur uppvärmning kan påverka liv, samspel och överlevnad.',
    summary: 'Sanitiserad grundning: delområdet jämför biologisk funktion och global.',
    tags: ['biologisk funktion', 'begrepp']
  },
  {
    kp: '004',
    typ: 'jämförelse',
    niva: 2,
    stem: 'Två miljöer värms lika mycket. I A finns svalare områden nära, i B är arterna mer instängda. Vad behöver jämföras biologiskt?',
    correct: 'Hur arternas funktion påverkas av möjlighet att byta livsmiljö',
    wrong: ['Vilken miljö där värmen sammanfaller med bäst födotillgång', 'Vilken miljö som har tydligast kortsiktig populationsökning', 'Vilken art som har bredast födoval i nuläget'],
    rationales: ['Första dagen räcker inte för biologisk funktion över tid.', 'Kortsiktig ökning behöver kopplas till livsmiljö och funktion över tid.', 'Födoval i nuläget behöver vägas mot uppvärmning och rörlighet.'],
    solution: 'Samma uppvärmning kan ge olika biologiska följder beroende på livsmiljö och rörlighet.',
    summary: 'Sanitiserad grundning: delområdet tränar jämförelse av biologisk funktion.',
    tags: ['biologisk funktion', 'jämförelse']
  },
  {
    ...
    typ: 'mcq',
    niva: 2,
    stem: 'En art får sämre fortplantning när varmare vår gör att födan toppar tidigare. Vad jämförs biologiskt?',
    correct: 'Hur uppvärmning ändrar tidsmatchning mellan föda och fortplantning',
    wrong: ['Hur födans mängd kan antas öka när våren blir varmare', 'Hur fortplantning blir starkare av kortare födotopp', 'Hur vårtemperatur kan ersättas med artens storlek'],
    rationales: ['Födomängd behöver eget stöd och kan inte bara antas öka.', 'Kortare eller tidigare födotopp kan skapa risk.', 'Artstorlek ersätter inte temperatur och timing.'],
    solution: 'Biologisk funktion kan påverkas när uppvärmning ändrar timing mellan arter.',
    summary: 'Sanitiserad grundning: delområdet tränar casebaserad biologisk funktion.',
    tags: ['biologisk funktion', 'uppvärmning']
  },
  {
    kp: '004',
    typ: 'resonemang',
    niva: 3,
    stem: 'En population växer i ett varmare område men minskar i ett annat. Vad gör jämförelsen rimlig?',
    correct: 'Att väga flera funktioner och livsmiljöer innan slutsatsen görs global',
    wrong: ['Att området där populationen ökade mest får störst vikt', 'Att området där minskningen syns tydligast får styra slutsatsen', 'Att låta populationsstorlek ersätta information om funktion'],
    rationales: ['Störst ökning kan ge ensidig slutsats.', 'Tydlig minskning behöver vägas mot andra underlag.', 'Population behöver kopplas till funktion och miljö.'],
    solution: 'En rimlig jämförelse visar att global uppvärmning kan ge olika biologiska följder i olika miljöer.',
    summary: 'Sanitiserad grundning: delområdet tränar avvägt resonemang.',
    tags: ['biologisk funktion', 'resonemang']
  },
  {
    ...
    typ: 'modell',
    niva: 2,
    stem: 'En modell jämför två biologiska funktioner vid uppvärmning: fortplantning och födosök. Vad behöver modellen visa?',
    correct: 'Hur varje funktion stärks eller försvagas när temperaturen förändras',
    wrong: ['Vilken funktion som förändras snabbast direkt efter uppvärmning', 'Vilken funktion som förbättras först även när den andra försvagas', 'Vilken funktion som mätts i en region och får gälla båda'],
    rationales: ['Snabbast förändring behöver kopplas till styrka och riktning över tid.', 'En tidig förbättring behöver vägas mot den andra funktionen.', 'En regions mätning räcker inte för båda funktionerna.'],
    solution: 'Modellen bör visa temperaturförändringens följder för biologiska funktioner.',
    summary: 'Sanitiserad grundning: delområdet tränar jämförande modell.',
    tags: ['biologisk funktion', 'modell']
  },
  {
    ...
    typ: 'samband',
    niva: 1,
    stem: 'I flera regioner blir våren varmare, insekter blir aktiva tidigare och fåglar behöver föda under häckningen. Vad gör påståendet biologiskt?',
    correct: 'Det kopplar uppvärmning till samspel mellan insekter och andra arter',
    wrong: ['Insektsarten med tydligast kortsiktig spridning får bära påståendet', 'Det beskriver temperaturtrend men lämnar samspelet otestat', 'Det använder regionen med starkast förändring som globalt stöd'],
    rationales: ['Kortsiktig spridning behöver kopplas till biologiskt samspel.', 'Temperaturtrend behöver biologisk följd.', 'En region räcker inte för globalt stöd.'],
    solution: 'Ett biologiskt påstående visar hur uppvärmning påverkar samspel, funktion eller livsmiljö.',
    summary: 'Sanitiserad grundning: delområdet tränar global i resonemang.',
    tags: ['global', 'biologiskt samband']
  },
  {
    kp: '005',
    typ: 'förståelse',
    niva: 2,
    stem: 'Ett argument säger att global uppvärmning påverkar fåglars häckning eftersom födan kommer tidigare. Vad behöver argumentet visa?',
    correct: 'Samband mellan uppvärmning, födotiming och häckningens funktion',
    wrong: ['Att häckningsplatsen ligger i samma region', 'Att födan observerats vid ett tillfälle', 'Att fågelarten är vanlig i en region'],
    rationales: ['Samma region visar inte kopplingen mellan timing och funktion.', 'Ett observationstillfälle ger svagt stöd för timing.', 'Vanlighet visar inte hur funktionen påverkas.'],
    solution: 'Argumentet blir biologiskt när temperaturförändring kopplas till timing och häckningsfunktion.',
    summary: 'Sanitiserad grundning: delområdet tränar förståelse av global uppvärmning.',
    tags: ['global', 'förståelse']
  },
  {
    kp: '005',
    typ: 'mcq',
    niva: 2,
    stem: 'En art sprids norrut samtidigt som medeltemperaturen ökar i flera regioner. Vilket påstående är bäst?',
    correct: 'Det kan vara ett biologiskt samband, men spridningen behöver följas över tid',
    wrong: ['Spridningen visar att artens funktion är oförändrad i de nya miljöerna', 'Norrut talar främst för att arten gynnas biologiskt', 'Temperaturökning i regioner räcker för att bedöma artens fortplantning'],
    rationales: ['Funktion kan skilja mellan miljöer.', 'Riktning behöver kopplas till funktion och underlag.', 'Fortplantning behöver eget biologiskt stöd.'],
    solution: 'Ett starkt påstående kopplar spridning till uppvärmning men avgränsar slutsatsen.',
    summary: 'Sanitiserad grundning: delområdet tränar påstående om global uppvärmning.',
    tags: ['global', 'biologisk funktion']
  },
  {
    kp: '005',
    typ: 'resonemang',
    niva: 3,
    stem: 'Flera regioner blir varmare, men en art ökar i en region och minskar i en annan. Hur bör resonemanget hantera detta?',
    correct: 'Visa att global uppvärmning kan ge olika biologiska följder beroende på livsmiljö',
    wrong: ['Ökningen får bli bevis för stärkt funktion överallt', 'Minskningen får bli bevis för samma följd i varje region', 'Räkna regionerna och lämna artens funktion till senare'],
    rationales: ['En ökning i en region räcker inte för helheten.', 'En minskning i en region räcker inte för helheten.', 'Artens funktion behöver ingå i resonemanget.'],
    solution: 'Ett avvägt resonemang visar både globalt mönster och lokala biologiska skillnader.',
    summary: 'Sanitiserad grundning: delområdet tränar avvägt resonemang om global.',
    tags: ['global', 'resonemang']
  },
  {
    kp: '005',
    typ: 'jämförelse',
    niva: 2,
    stem: 'Två argument jämförs. A har temperaturtrend och ändrad blomning i flera regioner men kort pollinatörsdata. B har flerårig pollinatörsdata i en region under varmare vårar. Vad är rimligast?',
    correct: 'A ger bredare globalt stöd; B ger starkare lokalt pollineringsstöd',
    wrong: ['A väger tyngst för global trend och pollinering eftersom flera regioner ingår', 'B väger tyngst för global trend och pollinering eftersom uppföljningen är längre', 'A och B väger lika eftersom båda kopplar värme till blomning eller pollinering'],
    rationales: ['Flera regioner ger inte automatiskt pollineringsstöd.', 'Längre lokal uppföljning ger inte automatiskt globalt stöd.', 'De två argumenten har olika styrkor och begränsningar.'],
    solution: 'Ett starkt argument skiljer mellan globalt stöd och lokalt biologiskt stöd.',
    summary: 'Sanitiserad grundning: delområdet jämför biologiska argument.',
    tags: ['global', 'jämförelse']
  },
  {
    kp: '006',
    typ: 'samband',
    niva: 1,
    stem: 'Vilket exempel visar orsak och följd mellan uppvärmning och biologisk funktion?',
    correct: 'Högre medeltemperatur gör blomning tidigare, vilket kan ändra pollinering',
    wrong: ['Tidigare blomning driver den långsiktiga temperaturtrenden', 'Pollinering blir starkare direkt när våren kommer tidigt', 'En varm dag gör flera år av medeltemperatur stabila'],
    rationales: ['Orsakskedjan går från temperatur till biologisk timing.', 'Tidigare vår kan skapa både stöd och risk för pollinering.', 'En varm dag säger lite om flerårig medeltemperatur.'],
    solution: 'Orsak och följd syns när uppvärmning kopplas till ändrad biologisk timing och funktion.',
    summary: 'Sanitiserad grundning: delområdet behandlar uppvärmning som orsak och följd.',
    tags: ['uppvärmning', 'samband']
  },
  {
    kp: '006',
    typ: 'process',
    niva: 2,
    stem: 'Vattnet i en sjö blir varmare och en fiskart söker svalare djup. Vilken följd är rimlig att undersöka?',
    correct: 'Om födosök och fortplantning förändras när arten byter djup',
    wrong: ['Om fiskarna blir vanligare nära ytan trots varmare vatten', 'Om sjön får fler temperaturzoner medan födosök lämnas oklart', 'Om djupförflyttningen gör temperaturen global'],
    rationales: ['Varmare vatten och ytligare förekomst behöver prövas mot funktion.', 'Temperaturzoner behöver kopplas till artens funktion.', 'Djupförflyttning gör inte en lokal sjö global.'],
    solution: 'En biologisk följd handlar om hur artens funktion påverkas av varmare miljö.',
    summary: 'Sanitiserad grundning: delområdet tränar följder av uppvärmning.',
    tags: ['uppvärmning', 'biologisk funktion']
  },
  {
    kp: '006',
    typ: 'mcq',
    niva: 2,
    stem: 'En varmare vår följs av tidigare insektsaktivitet. Vad är orsaken i sambandet?',
    correct: 'Den ökade vårtemperaturen som ändrar timing i miljön',
    wrong: ['Insekternas tidigare aktivitet som värmer våren', 'Att kalendern byter månad samtidigt', 'Att växtplatsen ligger i en varmare region'],
    rationales: ['Insektsaktiviteten är följd i scenariot.', 'Kalenderbyte är tidsmarkör, inte biologisk orsak.', 'Regionens temperatur behöver kopplas till förändrad timing.'],
    solution: 'Orsaken är uppvärmningen; följden är förändrad biologisk timing.',
    summary: 'Sanitiserad grundning: delområdet tränar orsak i global uppvärmning.',
    tags: ['uppvärmning', 'orsak']
  },
  {
    kp: '006',
    typ: 'resonemang',
    niva: 3,
    stem: 'En studie visar uppvärmning och förändrad häckningstid i en fågelpopulation. Vad gör slutsatsen stark?',
    correct: 'Att visa temperaturtrend, ändrad häckning och gränsen för vad populationen säger',
    wrong: ['Att låta en häckningssäsong avgöra flera populationer', 'Att temperaturen blir enda mått på fortplantning', 'Att använda artens utbredning som ersättning för häckningsdata'],
    rationales: ['En säsong ger begränsat stöd.', 'Fortplantning behöver egen biologisk data.', 'Utbredning och häckning är olika underlag.'],
    solution: 'En stark slutsats visar orsak, biologisk följd och avgränsning.',
    summary: 'Sanitiserad grundning: delområdet tränar resonemang om orsak och följd.',
    tags: ['uppvärmning', 'resonemang']
  },
  {
    ...
    typ: 'begrepp',
    niva: 1,
    stem: 'Vilket exempel visar biologiskt samband i global uppvärmning?',
    correct: 'Uppvärmning förändrar livsmiljö, vilket påverkar artens funktion',
    wrong: ['Uppvärmning förändrar en mätserie, vilket påverkar hur diagrammet tolkas', 'Artens utbredning förändras, vilket gör temperaturen högre', 'Mätplatsen flyttas, vilket gör artens funktion global'],
    rationales: ['Diagramtolkning behöver biologisk koppling.', 'Utbredning är följd, inte orsak till temperaturen.', 'Mätplatsen säger inte hur artens funktion påverkas.'],
    solution: 'Biologiskt samband visar hur uppvärmning kan påverka livsmiljö och funktion.',
    summary: 'Sanitiserad grundning: delområdet repeterar biologiskt samband i global uppvärmning.',
    tags: ['biologiskt samband', 'begrepp']
  },
  {
    kp: '007',
    typ: 'förståelse',
    niva: 2,
    stem: 'Varför behöver global uppvärmning beskrivas som biologiskt samband?',
    correct: 'För att temperaturförändring kan påverka flera kopplade delar i ekosystem',
    wrong: ['För att flera regioner ger starkt stöd även när funktion följs kort', 'För att en artlista kan ersätta följder över tid', 'För att lokala mätningar blir globala när de är många'],
    rationales: ['Kort funktionsuppföljning ger begränsat biologiskt stöd.', 'Artlista behöver kopplas till funktion och tid.', 'Många lokala mätningar behöver rätt skala och samband.'],
    solution: 'Global uppvärmning blir biologiskt begriplig när temperatur kopplas till samspel, funktion och livsmiljö.',
    summary: 'Sanitiserad grundning: delområdet tränar förståelse av biologiskt samband.',
    tags: ['biologiskt samband', 'global']
  },
  {
    kp: '007',
    typ: 'mcq',
    niva: 2,
    stem: 'Ett område blir varmare, insekter blir aktiva tidigare och fåglar hittar föda vid annan tid. Vilket samband beskriver detta bäst?',
    correct: 'Uppvärmning kan ändra timing mellan arter och biologisk funktion',
    wrong: ['Tidigare insekter gör fåglarnas födosök oförändrat', 'Fåglarna ändrar temperaturen genom att hitta föda', 'Födotiden visar att uppvärmningen är samma i varje miljö'],
    rationales: ['Förändrad insektsaktivitet kan påverka födosök.', 'Fågelföda är följd, inte orsak till uppvärmningen.', 'Samma följd i varje miljö framgår inte av scenariot.'],
    solution: 'Sambandet går från uppvärmning till förändrad timing och följd för funktion.',
    summary: 'Sanitiserad grundning: delområdet tränar korrekt biologiskt samband.',
    tags: ['biologiskt samband', 'uppvärmning']
  },
  {
    ...
    typ: 'resonemang',
    niva: 3,
    stem: 'Ett biologiskt samband verkar koppla global uppvärmning till tidigare blomning. Pollinering har följts kortare tid. Vad är en rimlig slutsats?',
    correct: 'Det finns stöd för blomningseffekten, men pollinering behöver mer uppföljning',
    wrong: ['Blomningen räcker för att avgöra pollinering i flera regioner', 'Pollineringen får vara starkaste bevis trots kortare data', 'Sambandet bör bytas mot väderhändelser i slutsatsen'],
    rationales: ['Pollinering kräver eget underlag.', 'Kortare data ger svagare stöd.', 'Väderhändelser ersätter inte biologiskt samband.'],
    solution: 'En stark slutsats använder sambandet men avgränsar det till de funktioner som följts tillräckligt.',
    summary: 'Sanitiserad grundning: delområdet tränar sammanfattande resonemang om biologiskt samband.',
    tags: ['biologiskt samband', 'resonemang']
  }
];

const authoredKap2Sec03 = [
  {
    kp: '001',
    typ: 'begrepp',
    niva: 1,
    stem: 'Vad betyder klimatförändringar i ett biologiskt sammanhang?',
    correct: 'Långvariga klimatmönster förändras så att livsmiljöer och funktioner kan påverkas',
    wrong: ['En varm vecka visar att en livsmiljö har bytt funktion', 'En art flyttar och gör klimatmönstret varmare', 'Ett väderläge blir huvudförklaring till hela ekosystemet'],
    rationales: ['En vecka är för kort för klimatmönster.', 'Artens flyttning kan vara följd, inte orsak till klimatmönstret.', 'Ett väderläge behöver skiljas från klimat över tid.'],
    solution: 'Klimatförändringar handlar om långvariga mönster som kan ändra villkor för organismer och ekosystem.',
    summary: 'Sanitiserad grundning: delområdet behandlar klimatförändringar, åtgärder och konsekvenser.',
    tags: ['klimatförändringar', 'begrepp']
  },
  {
    kp: '001',
    typ: 'samband',
    niva: 2,
    stem: 'Flera år med torrare somrar följs av sämre återväxt i en växtpopulation. Vad gör kopplingen biologisk?',
    correct: 'Klimatmönstret kopplas till en funktion hos populationen',
    wrong: ['Torkan beskrivs som mätmetod för populationens storlek', 'Populationen används som ersättning för klimatdata', 'Återväxten väljs eftersom den syns tydligt i diagrammet'],
    rationales: ['Mätmetod är inte samma sak som biologisk funktion.', 'Populationen behöver kopplas till klimatdata, inte ersätta den.', 'Tydlighet räcker inte; funktionen behöver biologisk tolkning.'],
    solution: 'Ett biologiskt samband visar hur ett klimatmönster kan påverka funktion, överlevnad eller samspel.',
    summary: 'Sanitiserad grundning: delområdet tränar klimatförändringar som biologiskt samband.',
    tags: ['klimatförändringar', 'biologiskt samband']
  },
  {
    kp: '001',
    typ: 'mcq',
    niva: 2,
    stem: 'Vilken observation passar bäst som biologiskt underlag för klimatförändringar?',
    correct: 'Längre växtsäsong följs över tid tillsammans med förändrad pollinering',
    wrong: ['En blomma slår ut tidigt efter en solig helg', 'En mätstation visar hög temperatur vid ett tillfälle', 'En artlista skrivs om när området inventeras med ny metod'],
    rationales: ['En helg är kort vädervariation.', 'Ett tillfälle visar inte klimatmönster.', 'Ny metod kan ändra artlistan utan att visa biologisk följd.'],
    solution: 'Starkare underlag kopplar klimatmönster över tid till biologisk funktion eller samspel.',
    summary: 'Sanitiserad grundning: delområdet tränar säkra exempel på klimatförändringar.',
    tags: ['klimatförändringar', 'biologisk funktion']
  },
  {
    kp: '001',
    typ: 'resonemang',
    niva: 3,
    stem: 'Ett underlag visar varmare klimat i flera regioner, men biologiska data gäller en art. Vad är rimligast?',
    correct: 'Dra slutsats om arten och markera att andra funktioner behöver eget stöd',
    wrong: ['Låt artens förändring beskriva flera funktioner i varje region', 'Välj regionen med störst förändring som huvudbevis', 'Byt slutsatsen till korta väderhändelser som har fler mätpunkter'],
    rationales: ['En art kan inte bära flera funktioner utan stöd.', 'Störst förändring ger inte nödvändigtvis bäst biologiskt underlag.', 'Fler vädermätningar ersätter inte biologiska data.'],
    solution: 'Ett starkt resonemang avgränsar slutsatsen till den biologiska funktion som faktiskt har följts.',
    summary: 'Sanitiserad grundning: delområdet tränar avgränsat resonemang om klimatförändringar.',
    tags: ['klimatförändringar', 'resonemang']
  },
  {
    kp: '001',
    typ: 'jämförelse',
    niva: 2,
    stem: 'Två underlag jämförs. A visar klimatmönster under lång tid. B visar fortplantning hos en art under kortare tid. Vad behövs för starkast biologisk slutsats?',
    correct: 'En koppling mellan långvarigt klimatmönster och fortplantningens förändring',
    wrong: ['A väger tyngst eftersom klimatmönstret har längst tidsserie', 'B väger tyngst eftersom fortplantning är mer biologiskt än klimat', 'Det underlag som har flest siffror får avgöra slutsatsen'],
    rationales: ['Klimatdata behöver biologisk koppling.', 'Biologisk data behöver kopplas till klimatmönstret.', 'Antal siffror säger inte om sambandet är rätt.'],
    solution: 'Klimatförändringar blir biologiskt belagda när klimatmönster och funktion hålls ihop.',
    summary: 'Sanitiserad grundning: delområdet jämför klimatdata och biologisk funktion.',
    tags: ['klimatförändringar', 'jämförelse']
  },
  {
    kp: '002',
    typ: 'begrepp',
    niva: 1,
    stem: 'Vad är en åtgärd när klimatförändringar diskuteras biologiskt?',
    correct: 'En insats som ska minska påverkan eller stärka levande systems möjlighet att fungera',
    wrong: ['En beskrivning av att temperaturen redan har förändrats', 'En artobservation som saknar plan för uppföljning', 'En jämförelse där konsekvensen lämnas utanför'],
    rationales: ['Beskrivning av förändring är inte en insats.', 'Observationen behöver kopplas till en insats eller uppföljning.', 'Åtgärden behöver bedömas mot en möjlig konsekvens.'],
    solution: 'Åtgärder handlar om vad man gör och hur det kan påverka biologiska system.',
    summary: 'Sanitiserad grundning: delområdet behandlar åtgärder vid klimatförändringar.',
    tags: ['åtgärder', 'begrepp']
  },
  {
    kp: '002',
    typ: 'samband',
    niva: 2,
    stem: 'Ett område restaurerar våtmark för att hålla kvar vatten och ge livsmiljöer under torrare perioder. Vilket samband prövas?',
    correct: 'Åtgärden kan minska en klimatrelaterad belastning på biologiska funktioner',
    wrong: ['Våtmarken gör temperaturmönstret till en lokal mätfråga', 'Livsmiljön visar att klimatpåverkan är färdigförklarad', 'Restaureringen ersätter behovet av att följa arter över tid'],
    rationales: ['Åtgärden påverkar livsmiljö, inte hela klimatmönstret som mätfråga.', 'En livsmiljö behöver följas mot funktion och konsekvens.', 'Uppföljning behövs för att bedöma biologisk effekt.'],
    solution: 'En biologisk åtgärd prövas genom att koppla insatsen till funktioner som vattenhållning, livsmiljö och artrespons.',
    summary: 'Sanitiserad grundning: delområdet tränar samband mellan åtgärder och biologisk funktion.',
    tags: ['åtgärder', 'biologiskt samband']
  },
  {
    kp: '002',
    typ: 'mcq',
    niva: 2,
    stem: 'Vilken uppföljning visar bäst om en åtgärd har biologisk effekt?',
    correct: 'Följ både miljövillkor och hur arter använder livsmiljön efter insatsen',
    wrong: ['Mät om miljön ser grönare ut men lämna artanvändning oklart', 'Följ temperaturen efter insatsen men inte arternas funktion', 'Jämför insatsernas omfattning och lämna arterna utanför'],
    rationales: ['Utseende behöver kopplas till biologisk funktion.', 'Temperaturdata behöver kopplas till artrespons.', 'Omfattning behöver kompletteras med biologisk uppföljning.'],
    solution: 'Biologisk effekt kräver data om miljövillkor och funktion hos levande system.',
    summary: 'Sanitiserad grundning: delområdet tränar uppföljning av åtgärder.',
    tags: ['åtgärder', 'biologisk funktion']
  },
  {
    kp: '002',
    typ: 'resonemang',
    niva: 3,
    stem: 'En åtgärd minskar uttorkning i en livsmiljö, men artantalet har ännu inte ändrats tydligt. Vilken slutsats är mest rimlig?',
    correct: 'Åtgärden kan ha förbättrat villkor, men artrespons behöver följas längre',
    wrong: ['Åtgärden saknar biologisk betydelse eftersom artantalet är oförändrat nu', 'Artantalet bör ersättas med hur snabbt marken torkar', 'Åtgärden bör bedömas som färdig om en miljövariabel förbättras'],
    rationales: ['Artrespons kan komma senare och behöver uppföljning.', 'Miljövariabeln behöver kopplas till arter och funktion.', 'En variabel räcker inte för hela biologiska effekten.'],
    solution: 'Ett rimligt resonemang skiljer mellan förbättrade villkor och visad biologisk respons.',
    summary: 'Sanitiserad grundning: delområdet tränar avgränsade slutsatser om åtgärder.',
    tags: ['åtgärder', 'resonemang']
  },
  {
    kp: '002',
    typ: 'jämförelse',
    niva: 2,
    stem: 'Åtgärd A minskar utsläpp på lång sikt. Åtgärd B skapar skuggade livsmiljöer lokalt. Vad bör jämföras biologiskt?',
    correct: 'Vilken skala åtgärderna verkar på och vilken funktion de kan påverka',
    wrong: ['Vilken åtgärd som har störst yta men där funktionen inte följs', 'Vilken åtgärd som ger snabbast lokal förändring utan artrespons', 'Vilken åtgärd som kan redovisas med samma mått trots olika skala'],
    rationales: ['Stor yta behöver kopplas till biologisk funktion.', 'Snabb lokal förändring behöver kopplas till artrespons.', 'Olika skala kan kräva olika biologiska mått.'],
    solution: 'Åtgärder kan ha olika skala; biologiskt behöver man jämföra vilken funktion de riktas mot.',
    summary: 'Sanitiserad grundning: delområdet jämför åtgärder vid klimatförändringar.',
    tags: ['åtgärder', 'jämförelse']
  },
  {
    kp: '003',
    typ: 'begrepp',
    niva: 1,
    stem: 'Vad menas med konsekvenser av klimatförändringar för levande system?',
    correct: 'Följder som påverkar livsmiljöer, samspel eller biologiska funktioner',
    wrong: ['En förändring i hur mätvärden grupperas utan funktionskoppling', 'Platsen där förändringen syns tydligast men artrespons saknas', 'En kort observation som inte följs över tid'],
    rationales: ['Gruppering av data behöver kopplas till biologisk funktion.', 'Tydlig platsförändring behöver biologisk respons.', 'Kort observation ger svagt stöd för konsekvens.'],
    solution: 'Konsekvenser är biologiska följder, till exempel förändrade villkor, samspel eller funktioner.',
    summary: 'Sanitiserad grundning: delområdet behandlar konsekvenser av klimatförändringar.',
    tags: ['konsekvenser', 'begrepp']
  },
  {
    kp: '003',
    typ: 'modell',
    niva: 2,
    stem: 'En modell visar varmare vatten, lägre syretillgång och förändrat födosök hos fisk. Vad är konsekvensen i modellen?',
    correct: 'Att fiskens funktion i miljön kan förändras när vattnets villkor ändras',
    wrong: ['Att fisken gör vattnet varmare genom att byta plats', 'Att syretillgången ersätter behovet av artdata', 'Att födosöket visar hur mätstationen ska placeras'],
    rationales: ['Fiskens respons är följd, inte orsak till uppvärmningen.', 'Syredata behöver kopplas till artens funktion.', 'Mätstationens placering är inte den biologiska konsekvensen.'],
    solution: 'Konsekvensen är hur förändrade miljövillkor påverkar fiskens biologiska funktion.',
    summary: 'Sanitiserad grundning: delområdet tränar modellering av konsekvenser.',
    tags: ['konsekvenser', 'modell']
  },
  {
    kp: '003',
    typ: 'mcq',
    niva: 2,
    stem: 'Vilket påstående skiljer bäst mellan klimatförändring och biologisk konsekvens?',
    correct: 'Varmare vår är klimatförändring; ändrad häckningstid kan vara biologisk konsekvens',
    wrong: ['Ändrad häckningstid är orsaken till varmare vår', 'Varmare vår och häckningstid är samma typ av data', 'Biologisk konsekvens kan bedömas utan att funktionen beskrivs'],
    rationales: ['Sambandets riktning blir omvänd.', 'Klimatdata och biologisk data beskriver olika delar.', 'Konsekvensen behöver kopplas till funktion.'],
    solution: 'Klimatförändringen beskriver villkoret; konsekvensen beskriver biologisk följd.',
    summary: 'Sanitiserad grundning: delområdet tränar skillnaden mellan klimatförändring och konsekvens.',
    tags: ['konsekvenser', 'biologisk funktion']
  },
  {
    kp: '003',
    typ: 'resonemang',
    niva: 3,
    stem: 'Ett diagram visar färre individer efter flera varma år, men föda och sjukdom har inte undersökts. Hur bör konsekvensen formuleras?',
    correct: 'Som möjlig klimatrelaterad följd med behov av fler biologiska förklaringar',
    wrong: ['Som bevis för att värme ensam förklarar minskningen', 'Som tecken på att föda och sjukdom saknar betydelse', 'Som slutsats om varje population i samma art'],
    rationales: ['En faktor kan inte ensam förklara allt utan stöd.', 'Ej undersökta faktorer kan fortfarande påverka.', 'En population räcker inte för varje population.'],
    solution: 'En försiktig slutsats håller ihop klimatmönster, biologisk följd och osäkerhet.',
    summary: 'Sanitiserad grundning: delområdet tränar resonemang om konsekvenser.',
    tags: ['konsekvenser', 'resonemang']
  },
  {
    kp: '003',
    typ: 'jämförelse',
    niva: 2,
    stem: 'Konsekvens A är tidigare blomning. Konsekvens B är minskad frösättning. Vad är viktigast att jämföra biologiskt?',
    correct: 'Hur den första följden kan påverka nästa funktion i livscykeln',
    wrong: ['Om tidigare blomning är större förändring än frösättningen', 'Om frösättning kan bedömas från blomningstid utan pollineringsdata', 'Om de två följderna mäts i olika miljöer men ändå slås ihop'],
    rationales: ['Större förändring behöver kopplas till funktion.', 'Frösättning kräver stöd för mellanled som pollinering.', 'Olika miljöer behöver jämföras försiktigt.'],
    solution: 'Konsekvenser kan hänga ihop i kedjor där en förändring påverkar nästa biologiska funktion.',
    summary: 'Sanitiserad grundning: delområdet jämför biologiska konsekvenser.',
    tags: ['konsekvenser', 'jämförelse']
  },
  {
    kp: '004',
    typ: 'begrepp',
    niva: 1,
    stem: 'Varför behöver klimatförändringar beskrivas som biologiskt samband?',
    correct: 'För att förändrade villkor kan påverka arter, samspel och funktioner i flera led',
    wrong: ['För att temperaturdata kan användas som enda mått på artrespons', 'För att artförändringar kan tolkas utan livsmiljöns villkor', 'För att flera arter i en lista visar funktionen utan tidskoppling'],
    rationales: ['Temperaturdata behöver kopplas till biologisk respons.', 'Artförändringar behöver kopplas till villkor i livsmiljön.', 'Artlista behöver kopplas till funktion och tid.'],
    solution: 'Biologiskt samband visar hur klimatförändringar kan få följder för levande system.',
    summary: 'Sanitiserad grundning: delområdet tränar biologiskt samband.',
    tags: ['biologiskt samband', 'klimatförändringar']
  },
  {
    kp: '004',
    typ: 'samband',
    niva: 2,
    stem: 'En varmare och torrare miljö följs av färre groddplantor. Vilken kedja visar sambandet bäst?',
    correct: 'Klimatvillkor förändras, etablering påverkas och populationens framtid kan ändras',
    wrong: ['Groddplantorna minskar, vilket gör klimatvillkoren torrare', 'Populationens framtid avgörs av hur tydlig mätmetoden är', 'Torkan beskrivs fristående från växternas etablering'],
    rationales: ['Sambandets riktning blir omvänd.', 'Metodtydlighet behöver kopplas till biologiskt resultat.', 'Sambandet kräver koppling till etablering.'],
    solution: 'Sambandet går från förändrade villkor till biologisk funktion och möjlig följd för populationen.',
    summary: 'Sanitiserad grundning: delområdet tränar orsakskedjor i biologiskt samband.',
    tags: ['biologiskt samband', 'konsekvenser']
  },
  {
    kp: '004',
    typ: 'mcq',
    niva: 2,
    stem: 'Vilket exempel är starkast som biologiskt samband mellan klimat och ekosystem?',
    correct: 'Varmare vår ändrar insekters aktivitet och påverkar fåglars födosök',
    wrong: ['Varmare vår följs av fler insekter men fåglarnas födosök lämnas oklart', 'Fåglar observeras oftare samtidigt som insektsdata saknas', 'Insekters aktivitet ändras men tidpunkten kopplas inte till fåglarnas behov'],
    rationales: ['Insektsökning behöver kopplas till fåglarnas funktion.', 'Fågelobservationer behöver kopplas till bytesdata.', 'Timing behöver kopplas till fåglarnas födosök.'],
    solution: 'Ett biologiskt samband visar hur klimatvillkor påverkar samspel mellan organismer.',
    summary: 'Sanitiserad grundning: delområdet tränar exempel på biologiskt samband.',
    tags: ['biologiskt samband', 'samspel']
  },
  {
    kp: '004',
    typ: 'jämförelse',
    niva: 2,
    stem: 'Två arter påverkas av torrare somrar. Art A kan vila i fröbank, art B behöver fukt varje år. Vad bör jämföras?',
    correct: 'Hur arternas livscykler gör sambandet mellan torka och överlevnad olika',
    wrong: ['Vilken art som finns närmast den torra delen vid första inventeringen', 'Vilken art som ökar mest ett enskilt år', 'Vilken art som har flest observationer utan att livscykeln jämförs'],
    rationales: ['Första inventeringen räcker inte för livscykel och överlevnad.', 'Ett enskilt år ger begränsat stöd.', 'Fler observationer behöver kopplas till biologisk egenskap.'],
    solution: 'Samma klimatförändring kan ge olika följder beroende på biologiska egenskaper.',
    summary: 'Sanitiserad grundning: delområdet jämför biologiska samband.',
    tags: ['biologiskt samband', 'jämförelse']
  },
  {
    kp: '004',
    typ: 'resonemang',
    niva: 3,
    stem: 'En modell visar klimatförändring, livsmiljö och artrespons, men saknar mellanled. Vad bör läggas till?',
    correct: 'Vilket villkor i livsmiljön som ändras och vilken funktion som påverkas',
    wrong: ['Vilken artrespons som syns tydligast utan att livsmiljövillkoret anges', 'Vilken livsmiljö som förändras utan att artens funktion följs', 'Vilken temperaturtrend som är längst även om organismens funktion saknas'],
    rationales: ['Tydlig artrespons behöver kopplas till förändrat villkor.', 'Livsmiljöförändring behöver kopplas till funktion.', 'Lång temperaturtrend behöver biologisk funktionskoppling.'],
    solution: 'Ett biologiskt samband blir starkare när modellen visar mellanled mellan klimatvillkor och funktion.',
    summary: 'Sanitiserad grundning: delområdet tränar modellkritik av biologiskt samband.',
    tags: ['biologiskt samband', 'modell']
  },
  {
    kp: '005',
    typ: 'begrepp',
    niva: 1,
    stem: 'Vad betyder biologisk funktion när klimatkonsekvenser diskuteras?',
    correct: 'Hur organismen klarar överlevnad, födosök eller fortplantning',
    wrong: ['Hur klimatdata sammanfaller med antal men saknar processmått', 'Hur livsmiljön ändras när överlevnad och fortplantning lämnas oklart', 'Hur många individer som finns vid ett tillfälle utan funktion över tid'],
    rationales: ['Antal behöver kopplas till biologisk process.', 'Livsmiljöförändring behöver följas mot funktion.', 'Ett tillfälle ger svagt stöd för funktion över tid.'],
    solution: 'Biologisk funktion handlar om vad levande system gör och klarar i sin miljö.',
    summary: 'Sanitiserad grundning: delområdet behandlar biologisk funktion.',
    tags: ['biologisk funktion', 'begrepp']
  },
  {
    kp: '005',
    typ: 'förståelse',
    niva: 2,
    stem: 'En åtgärd skapar svalare mikroklimat för smådjur. Vad behöver följas för att bedöma biologisk funktion?',
    correct: 'Om smådjuren kan söka föda, överleva och föröka sig bättre i miljön',
    wrong: ['Om platsen blir svalare men smådjurens aktivitet lämnas oklar', 'Om temperaturen följs utan koppling till födosök eller överlevnad', 'Om åtgärdens placering bedöms utan att arter följs'],
    rationales: ['Svalare plats behöver kopplas till aktivitet och funktion.', 'Temperatur behöver kopplas till biologisk funktion.', 'Placering räcker inte utan artuppföljning.'],
    solution: 'Biologisk funktion bedöms genom processer som födosök, överlevnad och fortplantning.',
    summary: 'Sanitiserad grundning: delområdet tränar funktion vid åtgärder.',
    tags: ['biologisk funktion', 'åtgärder']
  },
  {
    kp: '005',
    typ: 'mcq',
    niva: 2,
    stem: 'En population ökar i antal men får sämre fortplantningsresultat under varmare år. Vilken tolkning är bäst?',
    correct: 'Antal och funktion behöver skiljas åt innan konsekvensen bedöms',
    wrong: ['Ökat antal visar att fortplantningen fungerar bättre', 'Fortplantningsdata bör ersättas med totalantalet', 'Varmare år kan tolkas utan biologiska funktionsdata'],
    rationales: ['Antal och fortplantning kan visa olika delar av funktionen.', 'Totalantalet räcker inte för fortplantningsfunktion.', 'Klimatdata behöver biologisk funktionskoppling.'],
    solution: 'Biologisk funktion kan kräva flera mått; antal och fortplantning säger inte samma sak.',
    summary: 'Sanitiserad grundning: delområdet tränar funktionsresonemang.',
    tags: ['biologisk funktion', 'konsekvenser']
  },
  {
    kp: '005',
    typ: 'resonemang',
    niva: 3,
    stem: 'En åtgärd verkar minska värmestress, men bara överlevnad har följts. Hur bör slutsatsen avgränsas?',
    correct: 'Till överlevnad, medan födosök och fortplantning kräver egen uppföljning',
    wrong: ['Till hela artens funktion eftersom en funktion förbättras', 'Till klimatmönstret eftersom åtgärden påverkar stress', 'Till alla arter i området eftersom miljön blivit svalare'],
    rationales: ['En funktion kan inte bära hela funktionsbilden.', 'Klimatmönster och värmestress behöver skiljas åt.', 'Andra arter behöver eget underlag.'],
    solution: 'Ett bra resonemang anger vilken funktion som stöds och vilka funktioner som återstår.',
    summary: 'Sanitiserad grundning: delområdet tränar avgränsat resonemang om biologisk funktion.',
    tags: ['biologisk funktion', 'resonemang']
  },
  {
    kp: '005',
    typ: 'jämförelse',
    niva: 2,
    stem: 'Två funktioner följs efter torrare somrar: födosök och fortplantning. Vad är viktigast att jämföra?',
    correct: 'Om funktionerna påverkas på olika sätt och om båda behövs för slutsatsen',
    wrong: ['Vilken funktion som visar snabbast förändring men saknar uppföljning', 'Vilken funktion som råkar ligga först i mätserien', 'Vilken funktion som har flest observationer utan koppling till slutsatsen'],
    rationales: ['Snabb förändring behöver följas mot biologisk betydelse.', 'Ordning i mätserien avgör inte funktionsvikt.', 'Fler observationer behöver kopplas till slutsatsen.'],
    solution: 'Funktioner kan påverkas olika; slutsatsen ska visa vilka funktioner som faktiskt har stöd.',
    summary: 'Sanitiserad grundning: delområdet jämför biologiska funktioner.',
    tags: ['biologisk funktion', 'jämförelse']
  },
  {
    kp: '006',
    typ: 'samband',
    niva: 1,
    stem: 'Vilken kedja visar rätt riktning vid klimatförändringar?',
    correct: 'Temperaturmönster ändras, livsmiljö påverkas och artens funktion kan förändras',
    wrong: ['Artens funktion ändras och gör temperaturmönstret långvarigt', 'Livsmiljön namnges och klimatförändringen blir förklarad', 'Mätmetoden ändras och följden blir biologisk'],
    rationales: ['Sambandets riktning blir omvänd.', 'Ett namn förklarar inte sambandet.', 'Mätmetod är inte i sig biologisk följd.'],
    solution: 'En tydlig biologisk kedja håller ihop klimatmönster, livsmiljö och funktion i rätt riktning.',
    summary: 'Sanitiserad grundning: delområdet tränar klimatförändringar som biologisk kedja.',
    tags: ['klimatförändringar', 'biologiskt samband']
  },
  {
    kp: '006',
    typ: 'process',
    niva: 2,
    stem: 'En torrare period följs av färre våtmarksarter. Vad behöver prövas för att visa följden biologiskt?',
    correct: 'Om torkan förändrar livsmiljön och om artminskningen hänger ihop med detta',
    wrong: ['Om artminskningen följer samma period men livsmiljön inte mäts', 'Om vattennivån ändras men artrespons mäts vid ett tillfälle', 'Om en annan art ökar och används som stöd för våtmarksarterna'],
    rationales: ['Samtidighet räcker inte utan livsmiljödata.', 'En mätning ger svagt stöd för artrespons.', 'En art ger begränsat stöd för våtmarksarternas respons.'],
    solution: 'Följden blir biologiskt belagd när miljöförändring och artrespons kopplas.',
    summary: 'Sanitiserad grundning: delområdet tränar processer från orsak till följd.',
    tags: ['klimatförändringar', 'biologiskt samband']
  },
  {
    kp: '006',
    typ: 'mcq',
    niva: 2,
    stem: 'En art börjar häcka tidigare samtidigt som våren blivit varmare under många år. Vad är rimligast att säga?',
    correct: 'Det kan vara en följd av ändrad timing, men sambandet behöver följas över tid',
    wrong: ['Häckningen visar att våren blir varmare', 'Tidigare häckning förklarar varje annan art i området', 'Värmetrenden gör häckningsdata överflödiga'],
    rationales: ['Häckning är möjlig biologisk följd, inte klimatets orsak.', 'En art förklarar inte varje annan art.', 'Häckningsdata behövs för biologisk följd.'],
    solution: 'Ett rimligt påstående håller isär klimatmönster, biologisk timing och uppföljning.',
    summary: 'Sanitiserad grundning: delområdet tränar orsak/följd i biologisk timing.',
    tags: ['klimatförändringar', 'biologisk funktion']
  },
  {
    kp: '006',
    typ: 'resonemang',
    niva: 3,
    stem: 'Ett underlag visar klimatförändring, en åtgärd och en möjlig konsekvens. Vad gör resonemanget starkt?',
    correct: 'Att visa vilken del som är orsak, vilken som är insats och vilken följd som mäts',
    wrong: ['Att slå ihop orsak, åtgärd och följd till ett enda påstående', 'Att välja den del som är mest positiv som slutsats', 'Att lämna mätningen utanför när sambandet verkar rimligt'],
    rationales: ['Delarna behöver skiljas åt för att sambandet ska gå att pröva.', 'Positiv riktning räcker inte för evidens.', 'Mätning behövs för att pröva följden.'],
    solution: 'Starka resonemang skiljer orsak, åtgärd och konsekvens och kopplar dem till data.',
    summary: 'Sanitiserad grundning: delområdet tränar resonemang om klimatförändringar, åtgärder och konsekvenser.',
    tags: ['klimatförändringar', 'resonemang']
  },
  {
    kp: '007',
    typ: 'begrepp',
    niva: 1,
    stem: 'Vilket exempel beskriver en åtgärd mot biologiska konsekvenser av klimatförändringar?',
    correct: 'Att skapa spridningsvägar så arter lättare kan nå lämpliga livsmiljöer',
    wrong: ['Att flytta arter utan att följa om deras livsmiljökrav uppfylls', 'Att markera möjliga livsmiljöer utan biologisk koppling mellan dem', 'Att välja platsen där påverkan syns mest men utan att minska sårbarheten'],
    rationales: ['Flyttning behöver följas mot artens krav och funktion.', 'Möjliga livsmiljöer behöver faktiskt kopplas biologiskt.', 'Synlig påverkan är inte samma sak som minskad sårbarhet.'],
    solution: 'En åtgärd är en insats som kan minska risk eller stärka biologisk funktion.',
    summary: 'Sanitiserad grundning: delområdet tränar begreppet åtgärder.',
    tags: ['åtgärder', 'begrepp']
  },
  {
    kp: '007',
    typ: 'förståelse',
    niva: 2,
    stem: 'Varför behöver åtgärder kopplas till konsekvenser?',
    correct: 'För att man ska kunna bedöma om insatsen påverkar den biologiska följd man vill minska',
    wrong: ['För att åtgärden ska kunna beskrivas utan biologiska data', 'För att konsekvensen ska räknas som löst när insatsen startar', 'För att klimatmönstret ska ersättas med en artlista'],
    rationales: ['Biologisk data behövs för bedömningen.', 'Startad insats visar inte effekten.', 'Artlista ersätter inte klimatmönster eller följd.'],
    solution: 'Åtgärder behöver följas mot konsekvensen de är tänkta att påverka.',
    summary: 'Sanitiserad grundning: delområdet tränar åtgärder kopplade till konsekvenser.',
    tags: ['åtgärder', 'konsekvenser']
  },
  {
    kp: '007',
    typ: 'mcq',
    niva: 2,
    stem: 'En kommun skapar gröna stråk mellan livsmiljöer. Vilken fråga visar bäst om åtgärden fungerar biologiskt?',
    correct: 'Om arter faktiskt använder stråken och deras funktion i miljön stärks',
    wrong: ['Om stråken ligger nära livsmiljöer men artanvändning lämnas otestad', 'Om planen visar fler kopplingar utan biologisk uppföljning', 'Om åtgärden nämns med klimat men saknar funktionsmått'],
    rationales: ['Närhet behöver prövas mot faktisk artanvändning.', 'Planerade kopplingar visar inte biologisk effekt utan uppföljning.', 'Klimatkoppling behöver funktionsmått.'],
    solution: 'Åtgärdens biologiska värde bedöms genom artrespons och funktion, inte bara planbeskrivning.',
    summary: 'Sanitiserad grundning: delområdet tränar biologisk uppföljning av åtgärder.',
    tags: ['åtgärder', 'biologisk funktion']
  },
  {
    kp: '007',
    typ: 'resonemang',
    niva: 3,
    stem: 'Två åtgärder har olika mål: en minskar utsläpp, en stärker livsmiljö lokalt. Hur bör de vägas i ett biologiskt resonemang?',
    correct: 'Genom att skilja på klimatdrivande orsak och lokal minskning av biologisk sårbarhet',
    wrong: ['Genom att låta den mest synliga åtgärden bära hela slutsatsen', 'Genom att räkna dem som samma biologiska effekt', 'Genom att bedöma dem utan att ange vilken konsekvens de riktas mot'],
    rationales: ['Synlighet behöver inte motsvara biologisk effekt.', 'Olika mål kan ge olika biologiska effekter.', 'Konsekvensen behövs för att bedöma åtgärden.'],
    solution: 'Ett bra resonemang visar vilken typ av problem varje åtgärd riktas mot och vilken biologisk följd som ska följas.',
    summary: 'Sanitiserad grundning: delområdet tränar jämförande resonemang om åtgärder.',
    tags: ['åtgärder', 'resonemang']
  }
];
...
const batches = [
  ...
  {
    idPrefix: 'bio-q-k2-sec02',
    importBatchId: 'biologi-k2-sec02-offline-batch-20260518',
    bookLocationId: 'bookedition-stella-biologi-ocr-v1:biologi-kap2-sec02',
    sourceClaimId: 'sourceclaim-bookedition-stella-biologi-ocr-v1-biologi-kap2-sec02',
    sourceAtomId: 'source-atom-bookedition-stella-biologi-ocr-v1-biologi-kap2-sec02',
    chapterCode: 'K2',
    delkapitel: 'K2-biologi-kap2-sec02',
    stella: 'Stella Biologi K2 delområde 2',
    authored: authoredKap2Sec02
  },
  {
    idPrefix: 'bio-q-k2-sec03',
    importBatchId: 'biologi-k2-sec03-offline-batch-20260518',
    bookLocationId: 'bookedition-stella-biologi-ocr-v1:biologi-kap2-sec03',
    sourceClaimId: 'sourceclaim-bookedition-stella-biologi-ocr-v1-biologi-kap2-sec03',
    sourceAtomId: 'source-atom-bookedition-stella-biologi-ocr-v1-biologi-kap2-sec03',
    chapterCode: 'K2',
