...
const included = [
  ...
  'reports/validation/reviewed-kp-seeds.json',
  'reports/validation/question-generation-readiness.json',
  'reports/validation/generated-contract-hashes.json',
  'scripts/regenerate-biologi-contract.mjs',
  'scripts/build-reviewed-kp-seeds.mjs',
  'scripts/build-question-candidate-batch.mjs',
  'scripts/validate-question-generation-readiness.mjs',
