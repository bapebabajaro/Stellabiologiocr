Read-only review. In this repository, review exactly these questions in questions/intake-candidates.jsonl: bio-q-k2-sec04-029.
...
Return PASS/FAIL per id. For FAIL, include exact repair text for failed stems/notes. Fill reports\validation\mpcq-batch-reviews\mpcq-final-refresh-sec04-029.review.json or return equivalent JSON with schemaVersion mpcq-readonly-review-v1.
