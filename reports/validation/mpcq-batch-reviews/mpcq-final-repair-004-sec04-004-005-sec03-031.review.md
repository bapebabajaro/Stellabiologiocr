Read-only review. In this repository, review exactly these questions in questions/intake-candidates.jsonl: bio-q-k2-sec04-004, bio-q-k2-sec04-005, bio-q-k2-sec03-031.
...
Return PASS/FAIL per id. For FAIL, include exact repair text for failed stems/notes. Fill reports\validation\mpcq-batch-reviews\mpcq-final-repair-004-sec04-004-005-sec03-031.review.json or return equivalent JSON with schemaVersion mpcq-readonly-review-v1.
