...
Return PASS/FAIL per id. For FAIL, include exact repair text for failed stems/notes. Fill reports\validation\mpcq-batch-reviews\mpcq-final-refresh-sec04-004-005-sec03-031.review.json or return equivalent JSON with schemaVersion mpcq-readonly-review-v1.
