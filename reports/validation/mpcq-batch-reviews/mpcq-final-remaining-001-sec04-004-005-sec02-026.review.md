Read-only review. In this repository, review exactly these questions in questions/intake-candidates.jsonl: bio-q-k2-sec04-004, bio-q-k2-sec04-005, bio-q-k2-sec02-026.
...
Return PASS/FAIL per id. For FAIL, include exact repair text for failed stems/notes. Fill reports\validation\mpcq-batch-reviews\mpcq-final-remaining-001-sec04-004-005-sec02-026.review.json or return equivalent JSON with schemaVersion mpcq-readonly-review-v1.
